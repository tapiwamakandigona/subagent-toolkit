...
| `SKILL.md` / role / pattern body | <3000 tokens | the procedure itself, concise |
...
**One asymmetry worth remembering:** an agent can recover from a missing reference (it asks, or reports blocked). It usually cannot recover from a missing constraint — it will do the work, confidently, wrong. When forced to cut a brief down, cut references first, constraints never.
